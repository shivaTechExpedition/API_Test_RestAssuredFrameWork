...
public class JsonSchemaValidate {
	public static void validateSchema(String actualResponse , String schemaFile) {
    	...
    	JSONObject jsonSchemaexpected = new JSONObject(new JSONTokener(Objects.requireNonNull(JsonSchemaValidate.class.getResourceAsStream("/SchemaValidators" + File.separator + schemaFile))));
